...
if (isset($_POST['insert_pro'])) {    // when button is clicked
    ...
    //     // Check if the current iteration is the last element of the array
    //     if ($key === count($output) - 1) {
    //         // Assign the current line to the $last_line variable
    //         $last_line = $line;
    //     }
        
    //     // Output JavaScript code to log each line to the console
    //     echo "<script>console.log('$line');</script>";
    // }

    $last_word = null; // Initialize the variable to store the last word

// Get the last line from the $output array
...
// Output the last word
    echo "<script>console.log('Last word of the last line: $last_word');</script>";

    
    // Output the last line separately if needed
    echo "<script>console.log('Last line: $last_line');</script>";
    flush();
    ob_flush();
