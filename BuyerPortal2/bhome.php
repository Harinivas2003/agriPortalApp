        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="input-group mb-1 ml-2 searchbox">
                ...
                <form action="SearchResult.php" method="get" enctype="multipart/form-data">
                    <input type="text" class="form-control " id="inlineFormInputGroup" name="search" placeholder="Search for rice items " style="width:500px;">
                </form>
            </div>
            <?php
            getUsername();
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="https://www.agriportal.com/">Agriportal</a></u> is a Multitrading Company for farmers</p>
