...
<nav class="navbar navbar-expand-xl ">
    ...
    if (isset($_GET['id'])) {
        ...
        while ($rows = mysqli_fetch_array($run_query)) {
            ...
            $broken_rice_grain = $rows['broken_rice_percent'];
            ...
            while ($rows = mysqli_fetch_array($runa_query)) {
                ...
                <div class='container'>
                    ...
                    <div class='texty' style='margin-top:2%; font-size:25px;'>Broken rice grain percentage: $broken_rice_grain %</div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="https://www.agriportal.com/">agriportal Corporation</a></u> is a Multitrading Company for farmers ang traders</p>
